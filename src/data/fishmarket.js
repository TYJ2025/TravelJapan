  ...
  menu: [
    {
      ...
      items: [
        ...
        { emoji: '🐟', jp: 'マクブ', ruby: 'マクブ', romaji: 'makubu', zh: '青衣（藍鸚嘴魚）', en: 'blue-spotted wrasse', desc: '高級的隆頭魚，白肉細緻，生魚片或鹽烤皆宜。' },
        { emoji: '🐟', jp: 'ミーバイ', ruby: 'ミーバイ', romaji: 'mībai', zh: '石斑魚', en: 'grouper', desc: '石斑魚的沖繩稱呼，肉質彈嫩鮮甜，煮湯或清蒸都好。' },
        { emoji: '🐟', jp: 'タマン', ruby: 'タマン', romaji: 'taman', zh: '星斑裸頰鯛（白星笛鯛）', en: 'emperor fish', desc: '裸頰鯛，白身高級魚，鹽烤與生魚片都美味。' },
        { emoji: '🐟', jp: 'アカジン', ruby: 'アカジン', romaji: 'akajin', zh: '紅九棘鱸（紅石斑）', en: 'red grouper', desc: '沖繩三大高級魚之一，紅色石斑，鮮味濃郁價格高。' },
        ...
        { emoji: '🐙', jp: 'タコ', ruby: 'タコ', romaji: 'tako', zh: '章魚', en: 'octopus', desc: '章魚，口感彈牙，常做生魚片或醋物。' },

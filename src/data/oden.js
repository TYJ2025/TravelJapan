  ...
  menu: [
    {
      ...
      items: [
        ...
        { emoji: '⬜', jp: 'はんぺん', ruby: 'はんぺん', romaji: 'hanpen', zh: '魚板（半片）', en: 'fish cake', desc: '柔軟蓬鬆的白色魚漿製品，入口即化。' },
        ...
        { emoji: '🍡', jp: 'つみれ', ruby: 'つみれ', romaji: 'tsumire', zh: '魚肉丸', en: 'fish dumpling', desc: '沙丁魚等魚漿捏成的丸子，鮮味濃郁。' },
        { emoji: '🥬', jp: 'ロールキャベツ', ruby: 'ロールキャベツ', romaji: 'rōru-kyabetsu', zh: '高麗菜捲', en: 'cabbage roll', desc: '高麗菜包肉餡燉煮，吸飽高湯後柔軟多汁。' },
        { emoji: '👝', jp: '餅巾着', say: 'もちきんちゃく', ruby: '<ruby>餅巾着<rt>もちきんちゃく</rt></ruby>', romaji: 'mochi-kinchaku', zh: '麻糬福袋', en: 'mochi pouch', desc: '油豆皮包麻糬綁成福袋狀，咬開拉絲又燙口。' },
